...
- [Coinkite launches 'BinaryWatch' Hub: tracks popular bitcoin software signature verification](https://www.nobsbitcoin.com/coinkite-releases-binarywatch-hub-tracks-popular/)
	- The [BinaryWatch.org](https://binarywatch.org/) website checks binaries from Bitcoin-related projects and monitors for any changes
	- The company also operates [bitcoinbinary.org](https://bitcoinbinary.org/) a service that archives [reproducible builds](https://bitcoinops.org/en/topics/reproducible-builds/) for Bitcoin-related projects.
...
- Mining in a bear market
	...
	- [Further analysis of the bear market impact on miners](https://bitcoinmagazine.com/business/bitcoin-miner-capitulation-could-set-price-bottom)
